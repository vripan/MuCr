...
let ticket_action = function (req, res, path) {
    switch (req.method) {
        case 'DELETE':
            views.vinyl.vinyl_delete(req, res, path);
            break;
        case 'PATCH':
            views.vinyl.vinyl_update(req, res, path);
            break;
        case 'GET':
            views.vinyl.vinyl_get(req, res, path);
            break;
        case 'POST':
            views.vinyl.vinyl_create(req, res, path);
            break;
        default:
...
let ticket_all_action = function (req, res, path) {
    switch (req.method) {
        case 'GET':
            views.vinyl.vinyl_all_get(req, res, path);
            break;
    }
};
...
let ticket_group_action = function (req, res, path) {
    switch (req.method) {
        case 'GET':
            views.vinyl.vinyl_group_get(req, res, path);
            break;
    }
};
